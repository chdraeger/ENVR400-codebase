# =================================================================================
# PRACTICE: Compare and visualize data pairs and groups within pairs
...
get_season <- function(date){
  ...
  ifelse(
    ...
    months.Date(date, abbreviate = TRUE) %in% c("Apr", "May", ?????, ?????, ?????, "Sep"),
    "s", "w")
...
plot(van$avg_temperature, wh$avg_temperature, # x, y
     ...
     col = c("gold2", ?????)[van$season_num], # color according to season
